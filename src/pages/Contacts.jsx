...
function Contact() {
  return (
    <div className='container flex items-center p-5 '>
      ...
      <h1 className=" m-5 text-3xl font-bold mb-4 flex justify-center text-[#f92e9e]">Contact Us</h1>
     ...
     <div className='w-[100%]'>
     <h1 className=" m-5 text-3xl font-bold mb-4 flex justify-center text-[#f92e9e]">Our Location</h1>
