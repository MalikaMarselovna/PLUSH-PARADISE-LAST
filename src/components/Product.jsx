...
function Product({item}) {
    ...
    const iconStyle = 'h-[40px] w-[40px] rounded-full bg-white flex items-center justify-center  m-3 cursor-pointer hover:bg-[#16ffbd] hover:text-white hover:scale-[1.1] easy-in duration-100 cursor:pointer'
  ...
  return (
    ...
    onMouseLeave={handleHoverExit}>
        ...
        <div className={`flex items-center justify-center w-[100%] h-[100%] absolute easy-in duration-100` + hoverEffect}>
            {/* icons */}
